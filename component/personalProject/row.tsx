...
export default function PersonalProjectRow({ payload }: PropsWithChildren<{ payload: IPersonalProject.Payload }>) {
  return (
    <EmptyRowCol>
...
function serialize(payload: IPersonalProject.Item): IRow.Payload {
